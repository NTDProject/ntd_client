    ...
    constructor(props) {
      ...
      after = (resp) => {
        ...
        this.setState({
          ...
          pass: Math.round((resp.pass / resp.sumUngVien *100)*100)/100,
          process: Math.round((resp.process / resp.sumUngVien *100)*100)/100,
          false: Math.round(((resp.sumUngVien - resp.process - resp.pass) / resp.sumUngVien *100)*100)/100,
          passPerSum: Math.round((resp.pass / resp.sumUngVien *100)*100)/100,
          listVT: resp.listVT,
